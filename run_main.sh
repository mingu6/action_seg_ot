...
for i in ${!actions[@]}; do
	...
	python3 train_ours.py -d ${actions[$i]} -c ${clusters[$i]} -ps 10 -ne 20 -g $gpu --seed $seed --group setting_10 --rho 0.1 -uw 0.03 -bn -km -ps 10 -et 0.06 -ee 0.02 -a 0.15 -ht 0.1 -vf 5 -lr 1e-3 -wd 1e-4 -pf 0.25 -lc -r 15 --wandb
done
